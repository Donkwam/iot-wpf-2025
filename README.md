...
4. 위도(Latitude), 경도(Longitude) 표현
    ...
    https://github.com/user-attachments/assets/925d09a7-7cfd-4d0a-9a6a-1ab3af1034b2
...
4. DB서버에 접속자 정보확인 쿼리
    ```sql
    SELECT * FROM information_schema.processlist LIMIT 10; -- 데이터가 10건 이상이면 limit10은 삭제
    ```
5. WPF MVVM 전체구현
6. MQTTPub.py와 Publish된 IoT데이터 WPF에서 Subscribe 예제

   
https://github.com/user-attachments/assets/3f4b2693-3673-4a1b-bf38-bfcc5d1fe473
