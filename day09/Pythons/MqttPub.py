...
PUB_ID = 'IOT83'    # 본인 아이피 마지막주소
BROKER = '210.119.12.83'    # 본인 아이피
PORT = 1883
TOPIC = 'smarthome/83/topic'    # publish/subscribe에서 사용할 토픽(핵심)
COLORS = ['RED', 'ORANGE', 'YELLOW', 'GREEN', 'BLUE', 'NAVY', 'PURPLE']
COUNT = 0

# [Fake] 센서 설정
SENSOR1 = "온습도센서셋팅"; PIN = 5
...
try:
    ...
    while True:
        ...
        raw_data['SENSING_DT'] = currtime.strftime(f'%Y-%m-%d %H:%M:%S') # C#에서 => 'yyyy-MM-dd HH:mm:ss'
